...
# a = pd.read_csv('FMO+Eg+RDKIT.csv')
a = pd.read_csv('FMO+Eg+Mordred.csv')
...
# for MFO+Eg+Descriptors  
b=a.drop(['Donor', 'Acceptor', 'Donor Smiles', 'Acceptor Smiles', 'Dhomo','Dlumo', 'Ahomo', 'Alumo','Jsc','Voc','FF','PCE','Toffset', 'Small Eg', 
          'EgOpt','L3'],axis=1)           #(if want to calculate only descriptors commentline this code and use code for only descriptors)

# for only descriptors
# b=a.drop(['Donor', 'Acceptor', 'Donor Smiles', 'Acceptor Smiles', 'Dhomo','Dlumo', 'Ahomo', 'Alumo','Jsc','Voc','FF','PCE','Ei', 'Small Eg',
#           'EgOpt','L3','Dh', 'Dl', 'Ah', 'Al', 'Eg', 'Hoffset', 'Loffset', 'Toffset', 'Ei',
#        'Eg-Ei'],axis=1)
...
def correlation(dataset, threshold):
    ...
    return col_corr
corr_features = correlation(z, 0.8)
